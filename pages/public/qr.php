...
<title>Menu — <?= e($table['tenant_name']) ?></title>
...
<style>
  ...
  .qr-card{background:var(--surface);border:1px solid var(--border);}
...
<div class="min-h-screen pb-20">
    <header class="sticky top-0 z-30 backdrop-blur bg-black/60 border-b border-white/10 p-4 text-center">
        ...
        <h1 class="font-bold text-xl mt-2"><?= e($table['tenant_name']) ?></h1>
        <p class="text-xs text-slate-400">Tavolo <?= e($table['code']) ?></p>
    </header>
